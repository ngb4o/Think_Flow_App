...
class _TextSummaryScreenState extends State<TextSummaryScreen> {
  ...
  @override
  void didUpdateWidget(TextSummaryScreen oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<TextSummaryBloc, TextSummaryState>(
              ...
              if (state is TextSummaryCreateTextLoadingState)
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: state is TextSummaryUpdateSummaryDetailLoadingState
